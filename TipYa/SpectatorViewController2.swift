...
/*class SpectatorViewController: UIViewController, UITableViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tvc = UITableViewController.init(style: UITableViewStylePlain)
